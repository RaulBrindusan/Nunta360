...
const translations = {
  ro: {
    ...
    // Media Page
    'media.title': 'Galerie Media',
    'media.subtitle': 'Vezi toate fotografiile și videoclipurile încărcate de invitați',
    'media.noQrCode': 'Nicio pagină QR generată',
    'media.noQrCodeDescription': 'Trebuie să generezi o pagină QR înainte de a putea vedea fișierele media încărcate.',
    'media.goToQrPage': 'Mergi la pagina QR',
    'media.noMedia': 'Nicio fotografie sau videoclip',
    'media.noMediaDescription': 'Invitații tăi nu au încărcat încă nicio fotografie sau videoclip.',
    'media.loading': 'Se încarcă media...',
    'media.error': 'Eroare la încărcarea fișierelor media',
    'media.images': 'Fotografii',
    'media.videos': 'Videoclipuri',
    'media.all': 'Toate',
    'media.viewImage': 'Vizualizează imaginea',
    'media.playVideo': 'Redă videoclipul',
    'media.download': 'Descarcă',
    'media.uploadedOn': 'Încărcat pe',
    'media.downloadAll': 'Descarcă Tot',
  ...
  en: {
    ...
    'media.subtitle': 'View all photos and videos uploaded by your guests',
    'media.noQrCode': 'No QR page generated',
    'media.noQrCodeDescription': 'You need to generate a QR page before you can view uploaded media files.',
    'media.goToQrPage': 'Go to QR page',
    'media.noMedia': 'No photos or videos',
    'media.noMediaDescription': 'Your guests haven\'t uploaded any photos or videos yet.',
    'media.loading': 'Loading media...',
    'media.error': 'Error loading media files',
    'media.images': 'Photos',
    'media.videos': 'Videos',
    'media.all': 'All',
